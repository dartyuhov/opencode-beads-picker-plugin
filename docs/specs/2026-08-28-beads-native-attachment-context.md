...
- Use a PDF attachment with a `data:application/pdf` URL containing a structured, read-only Beads issue representation; GitHub Copilot rejects generic text file media types.
